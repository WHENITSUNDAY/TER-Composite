...
void MeshReader::readNodes(ifstream& file) {
    ...
    cout << "Noeuds lus : " << mesh->getNbNodes() << endl;
}
...
void MeshReader::readElements(ifstream& file) {
    ...
    cout << "\nÉléments lus :" << endl;
    cout << "  - Triangles matrice (tag 1) : " << numTrianglesMatrix << endl;
    cout << "  - Triangles fibres (tag 2) : " << numTrianglesFiber << endl;
    cout << "  - Arêtes fibre-matrice (tag 11) : " << numEdgesFiberMatrix << endl;
    cout << "  - Arêtes bord (tag 12) : " << numEdgesBoundary << endl;
    cout << "  - Total triangles : " << mesh->getNbElements() << endl;
}

void MeshReader::printStatistics() const {
    cout << "\n=== Statistiques du maillage ===" << endl;
    cout << "Nombre de noeuds : " << mesh->getNbNodes() << endl;
    cout << "Nombre d'éléments : " << mesh->getNbElements() << endl;
    cout << "Nombre d'arêtes : " << edges.size() << endl;
}
